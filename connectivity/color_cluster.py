...
def save_texture_segment_ply(inputpath, outputpath, rgb_truncate_threshold=15, intersect_threshold=1e-6):

    intergraph = IntersectionGraph(inputpath)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-output","--ouputpath", type=str, default=None, help="path to where the segment result will output")
